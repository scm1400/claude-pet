...
const UI_STRINGS = {
  ko: {
    ...
    update_found: '새로운 업데이트가 있습니다. 다운로드할까요?',
  ...
  en: {
    settings_title: 'Claude Pet Settings',
    ...
    collection_title: "Pet's Quote Collection",
    ...
    update_found: 'A new update is available. Download now?',
    ...
    skin_mood_frame: 'Mood → Frame Animation',
    skin_frame_start: 'Start',
    skin_frame_end: 'End',
  ...
  ja: {
    ...
    update_found: '新しいアップデートがあります。ダウンロードしますか？',
